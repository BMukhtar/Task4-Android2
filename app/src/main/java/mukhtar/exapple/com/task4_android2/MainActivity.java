package mukhtar.exapple.com.task4_android2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ourDirectory  = Environment.getExternalStorageDirectory().getAbsolutePath()+"/" + "pictures/";

    }

    public void onClick(View v){
        String downloadUrl = "http://storage.mp3.cc/download/59548262/Ym1aZllhSy9VT29" +
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... sUrl) {
            ...
            try {
                ...
                output = new FileOutputStream(urlDirectory);
